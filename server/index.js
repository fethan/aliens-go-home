...
const client = jwksClient({
    jwksUri: 'https://dev-mv1f0rmg.eu.auth0.com/.well-known/jwks.json',
...
const players = [
    ...
    { id: 'd4', maxScore: 146, name: 'Sebastian Peyrott', picture: 'https://twitter.com/speyrott/profile_image', },
];
