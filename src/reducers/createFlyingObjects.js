import {
    createInterval, maxFlyingObjects, flyingObjectsStartingYAxis, flyingObjectsStarterPositions
}
...
const createFlyingObjects = (state) => {
    ...
    return {
        ...
        gameState: {
            ...state.gameState,
            flyingObjects: [
                ...state.gameState.flyingObjects, newFlyingObject
            ],
        },
